...
Career-Copilot 是一款面向求职场景的职业发展助手，围绕简历解析、JD 匹配分析、面经检索和模拟面试四条主链路，帮助用户从“准备材料”走到“实战演练”。
...
- 若模拟面试恢复异常，优先检查：
  - 浏览器 `localStorage`：`career-copilot-mock-interview-recoverable-sessions`
